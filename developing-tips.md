...
## # 2
The module is adapted to `4-lines serial interface` because it uses SDA, SCK, CS and A0 pins. Driver pins which select the 4-line interface: `P68`, `IM2`, `IM1` and `IM0` are logic 0 - `GND` voltage. Module works with standard `MODE_0` SPI and 8-bits word where MSB is shifted out as first.
